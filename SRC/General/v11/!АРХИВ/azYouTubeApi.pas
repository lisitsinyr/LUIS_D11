...
type
    TazInfo = record
        url, title, thumbnailUrl, description, channelId, videoId, duration,
            datePublished, genre, embedUrl: string;
        width, height: Integer;
        keywords, author: string;
        length_seconds: Integer;
        subscriber, view, like, unlike: string;
    end;
...
begin
    ...
    begin
        ...
        description :=
            TagClear (Parse(Source, 'og:description" content="', '"'));
